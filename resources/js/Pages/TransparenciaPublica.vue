...
const usoFondos = [
    { label: 'Programas y causas directas', pct: 82, color: 'bg-teal-500' },
    { label: 'Administración y operaciones', pct: 10, color: 'bg-amber-400' },
    { label: 'Comunicación y captación', pct: 5, color: 'bg-violet-500' },
    ...
    <PublicLayout>
        ...
        <section class="bg-gradient-to-br from-teal-700 to-emerald-600 text-white py-16">
            <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center">
                <h1 class="text-4xl sm:text-5xl font-extrabold mb-4">{{ t('transparency.title') }}</h1>
        ...
        <section class="py-16 bg-white">
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <h2 class="text-2xl font-extrabold text-slate-800 text-center mb-10">{{ t('transparency.metrics.title') }}</h2>
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-5">
                    <div v-for="m in metricasDisplay" :key="m.label"
                        class="bg-slate-50 rounded-2xl border border-slate-100 p-5 text-center hover:border-teal-200 transition">
            ...
            <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
                ...
                <div class="space-y-4">
                    <div v-for="r in displayReportes" :key="r.id"
                        class="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm hover:shadow-lg transition">
                        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                            <div class="flex items-start gap-4">
                                <div class="h-12 w-12 rounded-xl bg-gradient-to-br from-teal-500 to-emerald-600 flex items-center justify-center text-2xl flex-shrink-0">📄</div>
                                <div>
                            ...
                            <div class="flex-shrink-0">
                                <span v-if="r.archivo"
                                    class="inline-flex items-center gap-2 rounded-xl bg-teal-50 border border-teal-200 px-4 py-2 text-sm font-semibold text-teal-700 hover:bg-teal-100 transition cursor-pointer">
        ...
        <!-- Compromiso -->
        <section class="py-16 bg-gradient-to-br from-teal-700 to-emerald-700 text-white">
            <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
                <h2 class="text-3xl font-extrabold mb-4">Nuestro compromiso contigo</h2>
